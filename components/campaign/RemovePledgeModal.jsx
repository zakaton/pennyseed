...
export default function RemovePledgeModal({
  open,
  setOpen,
  selectedCampaign,
              ...
              <Dialog.Panel className="relative inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to remove your pledge to this
                ...
                <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                  {selectedCampaign && (
                    <form
                      method="POST"
                      action="/api/campaign/remove-pledge"
                  ...
                  <button
                    type="button"
                    className="inline-flex mt-3 w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:mt-0 sm:w-auto sm:text-sm"
                    onClick={() => setOpen(false)}
                  >
                    Cancel
                  </button>
